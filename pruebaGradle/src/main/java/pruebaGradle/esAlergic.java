 ...
 * @author Lucas
 */
public class esAlergic extends javax.swing.JFrame {
    ...
    public esAlergic(PersonalAdm u) {
        this.usuario = u;
        initComponents();
    ...
    private void initComponents() {
        ...
        OutM.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        OutM.setText("El paciente es alérgico a ese medicamento");
        getContentPane().add(OutM);
        OutM.setBounds(20, 40, 270, 30);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Mensajes.png"))); // NOI18N
        getContentPane().add(jLabel2);
        jLabel2.setBounds(-6, 0, 390, 150);
    ...
    private javax.swing.JLabel OutM;
